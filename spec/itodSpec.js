describe('itod suite', function() {
  var opts,
      timesArray = [
                    "Any", "Early (4a-8a)", "Morning (8a-12p)", "Afternoon (12p-5p)", "Evening (5p-9p)", "Night (9p-12a)", "12:00am", "12:15am",
                    "12:30am", "12:45am", "1:00am", "1:15am", "1:30am", "1:45am", "2:00am", "2:15am", "2:30am", "2:45am", "3:00am", "3:15am", "3:30am",
                    "3:45am", "4:00am", "4:15am", "4:30am", "4:45am", "5:00am", "5:15am", "5:30am", "5:45am", "6:00am", "6:15am", "6:30am", "6:45am",
                    "7:00am", "7:15am", "7:30am", "7:45am", "8:00am", "8:15am", "8:30am", "8:45am", "9:00am", "9:15am", "9:30am", "9:45am", "10:00am",
                    "10:15am", "10:30am", "10:45am", "11:00am", "11:15am", "11:30am", "11:45am", "12:00pm", "12:15pm", "12:30pm", "12:45pm", "1:00pm",
                    "1:15pm", "1:30pm", "1:45pm", "2:00pm", "2:15pm", "2:30pm", "2:45pm", "3:00pm", "3:15pm", "3:30pm", "3:45pm", "4:00pm", "4:15pm",
                    "4:30pm", "4:45pm", "5:00pm", "5:15pm", "5:30pm", "5:45pm", "6:00pm", "6:15pm", "6:30pm", "6:45pm", "7:00pm", "7:15pm", "7:30pm",
                    "7:45pm", "8:00pm", "8:15pm", "8:30pm", "8:45pm", "9:00pm", "9:15pm", "9:30pm", "9:45pm", "10:00pm", "10:15pm", "10:30pm",
  ...
  describe('When generating HTML to append to the page', function() {
    describe('The renderSelectOptions method', function() {
      beforeEach(function() {
      ...
      afterEach(function() {
        var foundSelect = document.querySelectorAll('.select')[0];
        return document.body.removeChild(foundSelect);
      });

      it('should append the options to the select drop down', function() {
        ITOD.renderSelectOptions(timesArray, '.select');
        var select = document.querySelectorAll('.select')[0],
            options = ITOD.generateOptionsHTML(timesArray),
            i = 0;

        for(i = 0; i < select.options.length; i += 1) {
          expect(select.options[i].outerHTML).toBe(options[i].outerHTML);
        }
      });

      it('should preselect the desired value', function() {
        ITOD.renderSelectOptions(timesArray, '.select', '8:00pm');
        var select = document.querySelectorAll('.select')[0];
        expect(select.value).toBe('8:00pm');
      });
    });

    describe('The generateOptionsHTML method', function() {
      it('should return an array', function() {
        expect(Array.isArray(ITOD.generateOptionsHTML(timesArray))).toBe(true);
      });

      it('should return an array of option elements', function() {
        var options = ITOD.generateOptionsHTML(timesArray),
            i = 0;
        for(; i < timesArray.length; i += 1) {
         expect(options[i].outerHTML).toBe('<option value="' + timesArray[i] + '">' + timesArray[i] + '</option>');
        }
      });
    });
  });
